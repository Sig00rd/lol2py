...
class lolcodeParser(Parser):
    ...
    ruleNames = ["program", "code_block", "statement", "loop", "declaration",
                 ...
                 "less", "add", "sub", "mul", "div", "mod", "cast", "all",
                 "any", "nope", "func"]
        ...
        try:
            ...
            while True:
                ...
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        (1 << lolcodeParser.T__2) | (1 << lolcodeParser.T__5) | (1 << lolcodeParser.T__7) | (
                        1 << lolcodeParser.T__8) | (1 << lolcodeParser.T__10) | (1 << lolcodeParser.T__12) | (
                                1 << lolcodeParser.T__17) | (1 << lolcodeParser.T__18) | (1 << lolcodeParser.T__23) | (
                                1 << lolcodeParser.T__25) | (1 << lolcodeParser.T__26) | (1 << lolcodeParser.T__27) | (
                                1 << lolcodeParser.T__28) | (1 << lolcodeParser.T__29) | (1 << lolcodeParser.T__30) | (
                                1 << lolcodeParser.T__31) | (1 << lolcodeParser.T__32) | (1 << lolcodeParser.T__33) | (
                                1 << lolcodeParser.T__34) | (1 << lolcodeParser.T__35) | (1 << lolcodeParser.T__37) | (
                                1 << lolcodeParser.T__38) | (1 << lolcodeParser.T__39) | (1 << lolcodeParser.LABEL) | (
                                1 << lolcodeParser.ATOM))) != 0)):
                    break
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def all(self):
            return self.getTypedRuleContext(lolcodeParser.AllContext, 0)

        def any(self):
            return self.getTypedRuleContext(lolcodeParser.AnyContext, 0)
    ...
    class AllContext(ParserRuleContext):
        ...
        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterAll"):
                listener.enterAll(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitAll"):
    ...
    def all(self):
        ...
        localctx = lolcodeParser.AllContext(self, self._ctx, self.state)
        self.enterRule(localctx, 50, self.RULE_all)
        self._la = 0  # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 240
    ...
    def any(self):
        ...
        localctx = lolcodeParser.AnyContext(self, self._ctx, self.state)
        self.enterRule(localctx, 52, self.RULE_any)
        self._la = 0  # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 251
    ...
    def func(self):
        ...
        try:
            ...
            while True:
                ...
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        (1 << lolcodeParser.T__23) | (1 << lolcodeParser.T__25) | (1 << lolcodeParser.T__26) | (
                        1 << lolcodeParser.T__27) | (1 << lolcodeParser.T__28) | (1 << lolcodeParser.T__29) | (
                                1 << lolcodeParser.T__30) | (1 << lolcodeParser.T__31) | (1 << lolcodeParser.T__32) | (
                                1 << lolcodeParser.T__33) | (1 << lolcodeParser.T__34) | (1 << lolcodeParser.T__35) | (
                                1 << lolcodeParser.T__37) | (1 << lolcodeParser.T__38) | (1 << lolcodeParser.T__39) | (
                                1 << lolcodeParser.LABEL) | (1 << lolcodeParser.ATOM))) != 0)):
                    break
